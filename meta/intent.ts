...
/**
 * Atomic create-or-fetch for contextual_ingest intents keyed by contextual
 * message id.
 *
 * Mirrors createRouxIngestIntentIdempotent, but uses the contextual ingest
 * uniqueness constraint added in migration 0019.
 *
 * @canon: chittycanon://gov/governance#classification-axes  STATUS:PENDING
 */
